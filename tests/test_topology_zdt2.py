...
for i, t in enumerate(topologies):
    ...
    # plt.close()
name = f"hyper_volumes_zdt2_agents_{num_agents}_iter_{num_iterations}_inertia_{inertia_weight}_cognitive_{cognitive_coefficient}_social_{social_coefficient}.npy"
np.save(name, hvs)
